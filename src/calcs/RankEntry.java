 ...
 *
 * <p>Instances are produced by {@link Calcs#roiOverHorizon}.
 * Fields are populated in that order; {@link #winProbDelta} defaults to {@code 0.0}
 * unless explicitly set by the caller.
 *
 * <p>The special {@link #WAIT_SENTINEL} project is used for the synthetic "Wait/Save" entry
 * representing the option of saving coins for a future purchase.
 * Callers should test {@link #isWaitEntry()} before accessing project-specific fields.
 */
public class RankEntry {
     ...
     * Defaults to {@code 0.0}; set explicitly via {@link Calcs#estimateWinProbDelta}
     * or {@link WinProbability#estimateWinProbDelta}.
     */
     ...
     * this captures cross-card synergies such as Molkerei bonuses from additional animal cards,
     * Markthalle bonuses from additional food cards, and 2d6 frequency shifts from Bahnhof.
     */
     ...
     * Defaults to {@code true}; set to {@code false} by callers that evaluate unaffordable cards.
     */

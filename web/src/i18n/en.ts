...
const en: Record<string, string> = {
  ...
  'h2h.ratingsRaw': 'Raw',
  'h2h.ratingsLuckAdj': 'Luck-adj.',
  'h2h.ratingsRawTip': 'Rating based on raw win rates.',
  'h2h.ratingsLuckAdjTip': 'Rating based on luck-adjusted win rates (removes dice fortune).',
  'h2h.ratingsNoLuckData': 'No luck data — run matches with luck tracking enabled.',

  // H2H Export/Import
  'h2h.export': 'Export',
  'h2h.import': 'Import',
  'h2h.importSuccess': '{imported} matches imported, {skipped} skipped (duplicates)',
  'h2h.importNone': 'No new matches found in file',

  // Sweep Results
  'sweep.nav': 'Sweep Results',
  'sweep.title': 'Sweep Optimization Results',
  'sweep.loading': 'Loading sweep data…',
  'sweep.noData': 'No sweep results found. Run SweepMain to generate data.',
  'sweep.runGroup': 'Run Group',
  'sweep.trials': 'Trials',
  'sweep.bestWr': 'Best WR',
  'sweep.opponent': 'Opponent(s)',
  'sweep.engine': 'Engine',
  'sweep.gamesPerTrial': 'Games / Trial',
  'sweep.convergence': 'Convergence',
  'sweep.convergenceDesc': 'Best win rate found over trial progression',
  'sweep.importance': 'Parameter Importance',
  'sweep.importanceDesc': 'Correlation of each parameter with win rate (absolute Pearson r)',
  'sweep.parallelCoords': 'Top Trials — Parallel Coordinates',
  'sweep.parallelCoordsDesc': 'Parameter values of the top trials, normalized to [0, 1] within each parameter range',
  'sweep.paramRanges': 'Parameter Ranges',
  'sweep.paramRangesDesc': 'Min/max of each parameter with top trial values highlighted',
  'sweep.topN': 'Top N',
  'sweep.trialIndex': 'Trial',
  'sweep.winRate': 'Win Rate',
  'sweep.bestSoFar': 'Best so far',
  'sweep.runDate': 'Date',
  'sweep.totalTime': 'Total Time',
  'sweep.importanceStrong': 'Strong (|r| > 0.3)',
  'sweep.importanceMod': 'Moderate (0.15–0.3)',
  ...
  'h2h.computeLuck': 'Compute Luck (slower)',
  'h2h.luckMode': 'Mode',
  'h2h.luckModeMc': 'Monte Carlo',
  'h2h.luckModeHeuristic': 'Heuristic (fast)',
  'h2h.luckSims': 'MC Sims',
  'h2h.diceFortune': 'Dice Fortune',
  'h2h.ownTurns': 'Own Turns',
  'h2h.oppTurns': 'Opponent Turns',
  'h2h.luckSummary': 'Luck Summary',
  'h2h.totalLuck': 'Total Luck',
  'h2h.luckOverTime': 'Luck Over Time',
  'h2h.lucky': 'Lucky',
  'h2h.unlucky': 'Unlucky',
  'h2h.luckyWin': 'Lucky win',
  'h2h.unluckyLoss': 'Unlucky loss',
  ...
  'h2h.cardName': 'Card',
  'h2h.cardCost': 'Cost',
  'h2h.cardTotalIncome': 'Total',
  'h2h.cardTurnsOwned': 'Turns',
  'h2h.cardIncomePerTurn': 'Inc/Turn',
  'h2h.cardRoi': 'ROI',
  'h2h.cardExpectedIncome': 'Expected',
  'h2h.cardActualVsExpected': 'Δ Act./Exp.',
};
